<template>
    <div>
        <QuickTable :data="tableData" :columns="columns" row-key="id" border default-expand-all>
        </QuickTable>
        <hr>
        <QuickTable :data="tableData" :columns="columns" row-key="id" border lazy :load="load"
