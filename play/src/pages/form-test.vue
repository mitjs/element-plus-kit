<template>
    <div class="">
        <QuickForm ref="formRef" require-asterisk-position="right" label-width="120px" :model="FormValue"
            :form-options="formOptions" @validate="onValidate" required @change="onChange" :col="8"
