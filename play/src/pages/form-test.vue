<template>
    <div class="">
        <QuickForm ref="formRef" :model="FormValue" :form-options="formOptions" label-suffix="：" label-width="100px"
            @validate="onValidate" required @change="onChange" reset-active-seach :col="12"
            :buttons="['search', { label: 'ss', type: 'cancel1' }, 'reset']" @search="onSearch">
            <!--  :rules="rules"  -->
...
const formOptions = ref([
    {
        type: 'slot', label: '2222', prop: 'name', col: 24, formItem: { required: false, 'label-suffix': '' }, component: {
            onInput: () => {
